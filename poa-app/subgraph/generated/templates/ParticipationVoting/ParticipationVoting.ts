...
export class ParticipationVoting__announceWinnerResult {
  value0: BigInt;
  value1: boolean;
...
export class ParticipationVoting__getProposalResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ParticipationVoting__getWinnerResult {
  value0: BigInt;
  value1: boolean;
...
export class ParticipationVoting extends ethereum.SmartContract {
  static bind(address: Address): ParticipationVoting {
    return new ParticipationVoting("ParticipationVoting", address);
  }
  ...
  announceWinner(
    _proposalId: BigInt,
  ): ParticipationVoting__announceWinnerResult {
    let result = super.call(
      "announceWinner",
    ...
    return new ParticipationVoting__announceWinnerResult(
      result[0].toBigInt(),
      result[1].toBoolean(),
    );
  }
  ...
  try_announceWinner(
    _proposalId: BigInt,
  ): ethereum.CallResult<ParticipationVoting__announceWinnerResult> {
    let result = super.tryCall(
      "announceWinner",
      "announceWinner(uint256):(uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(_proposalId)],
    ...
    return ethereum.CallResult.fromValue(
      new ParticipationVoting__announceWinnerResult(
        value[0].toBigInt(),
        value[1].toBoolean(),
      ),
    );
  ...
  getProposal(_proposalId: BigInt): ParticipationVoting__getProposalResult {
    let result = super.call(
      "getProposal",
    ...
    return new ParticipationVoting__getProposalResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getProposal(
    _proposalId: BigInt,
  ): ethereum.CallResult<ParticipationVoting__getProposalResult> {
    let result = super.tryCall(
      "getProposal",
      "getProposal(uint256):(uint256,uint256,uint256,uint256,address,uint256,bool,address)",
      [ethereum.Value.fromUnsignedBigInt(_proposalId)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ParticipationVoting__getProposalResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
