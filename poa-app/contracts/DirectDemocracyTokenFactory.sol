...
contract DirectDemocracyTokenFactory {
    ...
    function createDirectDemocracyToken(string memory name, string memory symbol, address _nftMembership, string[] memory _allowedRoleNames, string memory _POname) public {
