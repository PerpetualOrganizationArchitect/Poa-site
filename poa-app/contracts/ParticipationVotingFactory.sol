...
contract ParticipationVotingFactory {
    ...
    function createParticipationVoting(address _ParticipationToken, address _nftMembership, string[] memory _allowedRoleNames, bool _quadraticVotingEnabled, address _treasuryAddress, string memory POname) public returns (address){
