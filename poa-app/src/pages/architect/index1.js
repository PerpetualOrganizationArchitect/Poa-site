...
const ArchitectPage = () => {
  ...
  const handleOptionSelected = (selectedOptionValue) => {
    ...
    if (selectedOption && selectedOption.action) {
      console.log("Executing action for: ", selectedOptionValue);
  ...
  return (
    <Layout isArchitectPage>
      ...
      {showSpecificInput && (
        <MemberSpecificationModal onSave={handleSaveMemberTier} />
      )}
