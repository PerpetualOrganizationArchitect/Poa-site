...
const User = () => {
  ...
  //     try {
  //       await kubiMembershipNFTContract.mintMembershipNFT(
  //         account,
  //         2023,
  //         0,
  //         "yes"
  ...
  const renderJoinSteps = () => (
    <Text>Instructions to join will be here</Text>
  ...
  const renderMetamaskMessage = () => (
    <Text>Metamask message should appear</Text>
    //     <ScaleFade initialScale={0.8} in={true}>
    //       <>
    //         {!isConnected && (
    //           <>
    ...
    //                 Please refresh with Metamask. If you don't have Metamask, please
    //                 install it{" "}
    //                 <Link
